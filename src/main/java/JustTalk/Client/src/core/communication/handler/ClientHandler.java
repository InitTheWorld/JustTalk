...
import JustTalk.Client.src.core.communication.Client;
import JustTalk.Client.src.core.communication.ClientMessage.Heartbeat.HeartbeatRequest;
...
public class ClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object event) throws Exception {
        ...
        if (event instanceof IdleStateEvent) {
            ...
            ctx.writeAndFlush(new MessageStruct(HeartbeatRequest.TYPE, heartbeatRequest.toString()))
